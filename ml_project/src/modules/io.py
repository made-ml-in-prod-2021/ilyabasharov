...
def load_module(
    ...
    if os.path.exists(module_param.path):
        ...
        logger.info(f'{module.__class__.__name__} was loaded from {module_param.path}')
        ...
        logger.info(f'{module.__class__.__name__} was created from {module_param.import_from}')

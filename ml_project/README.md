...
│
├── modules
│	│		  		   <- Saved modules (models, preprocessors etc.)
│   ├── modes          <- Directiory with fitted models
...
│   │   ├── features.py
│   │   │              <- ... features included categorical, numerical, target.
